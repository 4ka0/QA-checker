            ...
            if not segment.target_text.isspace():
                ...
                for start_symbol in symbol_pairs:
                    ...
                    symbol_counts[start_symbol] = \
                        segment.target_text.count(start_symbol)
                    symbol_counts[end_symbol] = \
                        segment.target_text.count(end_symbol)
                ...
                for start_symbol in symbol_pairs:
                    ...
                    if start_symbol_count != end_symbol_count:
                        segment.unpaired_symbols.append(start_symbol +
                                                        end_symbol)
                ...
                if '\"' in segment.target_text:
                    if segment.target_text.count('\"') % 2 != 0:
